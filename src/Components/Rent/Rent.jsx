            ...
            <div className="container">
                <div className="rent-header">
                    <div className="rh-content">
                        <h2 className="title">Properties For <span className="text-gradient">Shell</span></h2>
                        <p className="text-muted">Find your temporary home from our curated rental list.</p>
                    </div>
                    {/* <button className="btn btn-outline">View All Shell <ArrowRight size={18} /></button> */}
                    <button
                        className="btn btn-outline"
                        onClick={() => navigate("/projects")}
                    >
                        View All Shell <ArrowRight size={18} />
                    </button>
                </div>
                ...
                <div className="rent-grid">
                    ...
                    >
                        ...
                        {/* <div className="rent-cta-card">
                            ...
                            <button className="btn btn-primary small">Contact Shell Team</button>
                        </div> */}
                    </Reveal>
                </div>
            </div>
